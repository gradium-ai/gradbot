...
export class GameUI {
   ...
   */
  showVoicePanel(question) {
    return new Promise((resolve) => {
      document.exitPointerLock();

      this._voicePanel.style.display = 'flex';
      this._voicePanel.querySelector('#voice-question').textContent = question;
  ...
  /**
   * Show a result in the voice panel and auto-close after a delay.
