...
class AudioProcessor {
  ...
  /**
   * Play incoming raw PCM audio data (16-bit signed LE, mono).
   * Bypasses the Opus decoder entirely — converts Int16 to Float32 and sends to worklet.
   * The PCM sample rate must match the AudioContext sample rate (48kHz).
   * @param {Uint8Array} pcmData - Raw PCM audio (Int16LE, mono, must match AudioContext rate)
